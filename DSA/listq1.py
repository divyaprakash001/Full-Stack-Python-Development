...
'''
    ...
    # 1
    def compare_expense(index1,index2):
        return expenses[index2]-expenses[index1]

    # 2
    def quarter_expense(index1,index2,index3):
        return expenses[index1]+expenses[index2] + expenses[index3]

    # 3
    def foundEqual(amount):
        return amount in expenses

    print(foundEqual(2000))

    # 4
    def addingMonthExpense(m_exp):
        expenses.append(m_exp)

    # 5
    def removeitem(index):
        expenses[index] = expenses[index]-200
        print(expenses)
'''
